...
See also [Extension Menu](/software/extension-menu.md) for general Weaving/Shift/D-A Output extension features that apply on top of this setup, and [Multi Pass Feature](/feature-guides/multi-pass.md) for additional Maven-agnostic features.
