...
![RB-MIG UI overview — Jog Control, Program View, and the left side bar menu](/program-buttons-overview.png)
...
![Setup menu — System Set, Utilities, TCP Set, Welding Set](/system-set-connection.png)
