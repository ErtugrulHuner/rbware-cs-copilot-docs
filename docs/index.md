...
tagline: Documentation and setup guides for Rainbow Robotics RB Cobot & RB-X welding systems.text: Start with Product Introduction
...
features:
  ...
  - title: RB-X / RB-MIG Software
    details: Software overview, setup menu reference, RB-X guide, and touch sensing workflow.
